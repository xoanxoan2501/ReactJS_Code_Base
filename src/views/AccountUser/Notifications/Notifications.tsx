  ...
  return (
    <LayoutBox sx={{ background: "#F2C2CF" }}>
      <Box sx={{ p: 3, borderRadius: 2, maxWidth: "100%", mx: "auto", mt: 4, padding: 1 }}>
        ...
        <Box sx={{ mt: 3, maxHeight: "470px", overflowY: "auto", pr: "1px",
          ...
          {filteredNotifications.map((item, index) => (
            <Box key={index} sx={{ display: "flex", alignItems: "center", backgroundColor: "#fff", mb: 3, padding: "30px", height: "150px", width: "100%" }}>
              <Box sx={{ mr: 2 }}>{item.status === "success" ? (
