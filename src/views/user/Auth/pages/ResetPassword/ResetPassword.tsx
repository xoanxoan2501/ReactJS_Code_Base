...
import { resetPasswordSchema, ResetPasswordSchemaType } from '@/utils/validationSchemas'
      ...
      <form onSubmit={handleSubmit(handleChangePassword)}>
        ...
        >
          <Box>
            ...
            />
            {errors.password && (
              <Typography sx={{ marginTop: '4px', color: 'red' }}>{errors.password.message}</Typography>
            )}
          </Box>
          <Box>
            <TextField
            ...
            {errors.confirmPassword && (
              <Typography sx={{ marginTop: '4px', color: 'red' }}>{errors.confirmPassword.message}</Typography>
            )}
          </Box>
          <Button
            sx={{
