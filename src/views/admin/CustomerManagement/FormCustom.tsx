...
import CustomerManagementLayout from './layout'
import TextFieldCustom from './TextFieldCustom'
import SelectCustom from './SelectCustom'
import { useLocation, useSearchParams, useNavigate } from 'react-router-dom'
import { routerAddCustomer, routerCustomerManagement } from './router'
import { zodResolver } from '@hookform/resolvers/zod'
import { SubmitHandler, useForm } from 'react-hook-form'
import { Customer, CustomerSchema } from './FormZod'
...
export default function FormCustomer() {
  ...
  const isAddPage = location.pathname.includes(routerAddCustomer.path)
  ...
  const onSubmit: SubmitHandler<Customer> = useCallback(
    (data: Customer) => {
      ...
      if (isAddPage) {
        AddProduct(formData).then((res) => {
          ...
          navigate(routerCustomerManagement.path)
        })
      } else {
